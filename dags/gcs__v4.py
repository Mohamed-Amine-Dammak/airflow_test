...
_TASK_RESUME_SCOPE_BY_ENTRY = {'gcs_1_node_1': ['gcs_1_node_1', 'gcs_2_node_3', 'gcs_3_node_4'],
 'gcs_2_node_3': ['gcs_2_node_3', 'gcs_3_node_4'],
 'gcs_3_node_4': ['gcs_3_node_4']}
...
def gcs_v4():
    ...
    def run_node_3():
        ...
        drive_directory_link = ''
        drive_file_links = []
        source_object = 'CUSTOMER_CUS_TEST.csv'
        destination_bucket_name = 'os-dpf-ariflow-prj-dev'
        destination_object = 'CUSTOMER_CUS_TEST.csv'
        delete_mode = 'single'
        object_name = 'CUSTOMER_CUS_TEST.csv'
        object_names = []
