...
def test_vortex_web_v2():
    ...
    def run_node_2():
        ...
        payload = {'bucket_name': 'os-dpf-vortex-prj-dev',
     'data_source': 'boond',
     'dataset': 'raw',
     'integration_source': 'n8n',
     'tables': {'ABSENCES': {'mode': 'full', 'separator': ';'},
                'ADMINISTRATIVE': {'mode': 'delta', 'separator': ';'},
                'AGENCIES': {'mode': 'full', 'separator': ';'},
                'COMPANIES': {'mode': 'full', 'separator': ';'},
                'CONTACTS': {'mode': 'full', 'separator': ';'},
                'DAYS_OFF': {'mode': 'full', 'separator': ';'},
                'DELIVERIES': {'mode': 'full', 'separator': ';'},
                'DICTIONARY': {'mode': 'full', 'separator': ';'},
                'EXTERNAL_DELIVERIES': {'mode': 'full', 'separator': '|'},
                'INVOICES': {'mode': 'full', 'separator': ';'},
                'POSTPRODUCTION_DETAILS': {'mode': 'delta', 'separator': ';'},
                'PREV_YEAR_LEAVE_BALANCE': {'mode': 'full', 'separator': ';'},
                'PROJECTS': {'mode': 'full', 'separator': ';'},
                'RESOURCES': {'mode': 'full', 'separator': ';'},
                'RESOURCES_IMAGES': {'mode': 'delta', 'separator': ';'},
                'TIMESHEET': {'mode': 'full', 'separator': ';'}}}
