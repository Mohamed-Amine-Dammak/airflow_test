...
_TASK_RESUME_SCOPE_BY_ENTRY = {'gcs_1_node_4': ['gcs_1_node_4',
 ...
 'parallel_fork_2_node_7': ['gcs_3_node_5',
                            ...
                            'parallel_fork_2_node_7',
                            'parallel_join_5_node_9'],
 'gcs_3_node_5': ['gcs_3_node_5', 'gcs_6_node_10', 'parallel_join_5_node_9'],
 'gcs_4_node_8': ['gcs_4_node_8', 'gcs_6_node_10', 'parallel_join_5_node_9'],
 'parallel_join_5_node_9': ['gcs_6_node_10', 'parallel_join_5_node_9'],
 'gcs_6_node_10': ['gcs_6_node_10']}
...
def gcs_v9():
    ...
    def run_node_5():
        ...
        drive_directory_link = ''
        drive_file_links = []
        source_object = 'CUSTOMER_CUS_TEST.csv/n8n_vs_langchain_langGraph.docx'
        destination_bucket_name = 'os-dpf-ariflow-prj-shr-dev'
        destination_object = 'n8n_vs_langchain_langGraph.docx'
        delete_mode = 'single'
        object_name = 'dataops.png'
        object_names = []
        delete_object_prefix = ''
    ...
    def run_node_10():
        ...
        object_name = ''
        object_names = ['elk.docx', 'n8n_vs_langchain_langGraph.docx']
        delete_object_prefix = ''
