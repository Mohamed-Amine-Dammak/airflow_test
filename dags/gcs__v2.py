...
_TASK_RESUME_SCOPE_BY_ENTRY = {'gcs_1_node_1': ['gcs_1_node_1', 'gcs_2_node_2'], 'gcs_2_node_2': ['gcs_2_node_2']}
...
def gcs():
    ...
    @task(task_id='gcs_2_node_2')
    def run_node_2():
        action = 'delete'
        bucket_name = 'os-dpf-ariflow-prj-shr-dev'
        service_account_file = '/opt/airflow/credgcp.json'
        destination_path = 'sample_upload.txt'
        upload_mode = 'single'
        source_type = 'local'
        local_file_path = '/mnt/cegid/CUSTOMER_CUS_TEST.csv'
        local_directory_path = ''
